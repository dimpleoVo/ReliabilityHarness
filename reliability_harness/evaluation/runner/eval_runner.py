import reliability_harness.evaluation.tasks.recognition_task
import reliability_harness.evaluation.tasks.qa_task
import reliability_harness.evaluation.tasks.detection_task
from collections import Counter

from reliability_harness.evaluation.datasets.registry import get_dataset
from reliability_harness.evaluation.metrics.edit_distance import normalized_edit_distance
from reliability_harness.evaluation.metrics.llm_judge import get_llm_judge_score

from reliability_harness.evaluation.analysis.invalid_output import detect_invalid_output
from reliability_harness.evaluation.analysis.error_attribution import attribute_error
from reliability_harness.evaluation.analysis.slice import run_slice_analysis
from reliability_harness.evaluation.analysis.badcase import mine_badcases
from reliability_harness.evaluation.analysis.error_patterns import mine_error_patterns

from reliability_harness.evaluation.reports.report import generate_report, generate_badcase_html
from reliability_harness.evaluation.reports.badcase_debugger import write_badcase_debugger_html
from reliability_harness.evaluation.utils import ensure_dir, dump_json
from reliability_harness.evaluation.tasks.task_registry import get_task

from reliability_harness.evaluation.analysis.failure_discovery.weak_slice import detect_weak_slices
from reliability_harness.evaluation.analysis.failure_discovery.failure_boundary import detect_failure_boundaries
from reliability_harness.evaluation.analysis.failure_discovery.risk_region import discover_risk_regions
from reliability_harness.evaluation.datasets.registry import get_dataset
from reliability_harness.evaluation.tasks.task_registry import get_task, auto_import_tasks
